...
public class CollegeAdapter  extends  RecyclerView.Adapter<CollegeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CollegeAdapter.ViewHolder holder, int position) {
        ...
        holder.textname.setText(model.getCollege_name());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    intent.putExtra("college_name",model.getCollege_name());
                ...
                Toast.makeText(context, "You clicked "+model.getCollege_name(), Toast.LENGTH_SHORT).show();
            }
        });
            }
